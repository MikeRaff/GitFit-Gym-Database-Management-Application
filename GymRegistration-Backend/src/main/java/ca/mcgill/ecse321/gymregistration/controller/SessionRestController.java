...
public class SessionRestController {
    ...
    @PutMapping(value = { "/sessions/{id}", "/sessions/{id}/" })
    public ResponseEntity<SessionDto> updateSession(@PathVariable("id") int id, @PathVariable("email") String email,
            @RequestBody SessionDto sessionDto) throws IllegalArgumentException {
        GymUser gymUser = null;
        try {
            gymUser = instructorService.getInstructorByEmail(email);
    ...
    public void deleteSession(@PathVariable("id") int id, @PathVariable("email") String email)
            throws IllegalArgumentException {
        GymUser gymUser = null;
        try {
            gymUser = instructorService.getInstructorByEmail(email);
